...
class Trainer:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.n_workers = kwargs.pop("n_workers", 8)
        self.seed = kwargs.pop("seed", 2024)
        ...
        self.train_data, self.valid_data = make_dataset(
            ...
            conditions_list=self.conditions_,
    ...
    def train(self, q, k, n_epochs=400, lr=1e-3, eps=0.01):
        ...
        for self.epoch in range(n_epochs):
            ...
            for self.iter, batch_data in enumerate(self.dataloader_train):
                ...
                # Loss Calculation
                self.on_iteration(k, batch_data)
    ...
    def on_iteration(self, k, batch_data):
        ...
        self.current_loss = loss = self.loss(k, batch_data)
    ...
    def validate(self, k):
        ...
        for val_iter, batch_data in enumerate(self.dataloader_valid):
            ...
            val_loss = self.loss(k, batch_data)
